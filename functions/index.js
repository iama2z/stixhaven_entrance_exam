...
*AI ACTION:* Once they pick a job, assign it to the 'selectedJob' JSON key. If they pick "Unemployed", set 'selectedJob' to "Unemployed" and set 'selectedStipend' to an empty string.
